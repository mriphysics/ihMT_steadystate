...
%%% In actual fact there is no need to simulate the transverse free pool
%%% components here. But we will leave them in to match the notation in the
%%% paper
...
% Free pool transverse components - IGNORE OFF RESONANCE during evolution
La = [-R2f 0;0 -R2f];
...
% Transverse spoiling matrix - equivalent to T2->0
